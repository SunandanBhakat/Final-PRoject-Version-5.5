...
<body>
	...
	<div class="container-fluid">
			<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
					<a class="navbar-brand" href="http://localhost:8085/Way2Policy/">
			...
			<c:if test="${commit eq true }">
				...
				<!-- Condition Checker Ends -->
					...
					<div class="row">
						...
						<div class="col-md-4">
							<div class="form-group">
								<form:label path="id"><font size="4">Vendor Id</font></form:label>
					...
					<div class="row">
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<form:input path="tan" type="text" class="form-control" required="required"/>
							</div>
						</div>
					</div>	
					<div class="row">
