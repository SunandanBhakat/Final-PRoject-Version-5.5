...
<body id="body">
  ...
  <div class="row">
   <div class="col-md-2">
				...
				<div class="container">
					...
					<div class="card-body">
						<h5 class="card-title">NAME:${sessionScope.userData.firstName}&nbsp;&nbsp;&nbsp;${sessionScope.userData.lastName}</h5>
					</div>
					
					<div class="card-body">
						<h6 class="card-title" style="margin-left:50px">Vendor</h6>
						...
						<h5 class="card-title">QUALIFICATION:${sessionScope.userData.qualification}</h5>
					</div>
  ...
  <c:url var="crossAction" value="/user/search"></c:url>
