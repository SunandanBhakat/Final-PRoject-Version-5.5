...
<%response.sendRedirect("/Way2Policy/"); %>
	...
	<c:url var="homeAction" value="${'/user/search'}"></c:url>
	...
	<div class="container-fluid">
		...
		<form method="post" action="${createTransactionCredit}" id="form"
			...
			<div class="row">
				<div class="col-md-2">
					<div class="form-group">
						<label><font size="4">Full Name(On Card)</font></label> <input
			...
			<div class="row">
				<div class="col-md-2">
					<div class="form-group">
						<label><font size="4">Card Number</font></label> <input
			...
			<div class="row">
				...
				<div class="col-md-2">
					<div class="form-group">
						<label><font size="4">CVV</font></label> <input type="text"
			...
			<button type="button" class="btn btn-primary btn-lg"	 >Cancel
				Transaction</button>
		</form>
	</div>
	</div>
	...
	<form method="post" action="${createTransactionDebit}" id="form1"
		...
		<div class="row">
			<div class="col-md-2">
				<div class="form-group">
					<label><font size="4">Card Number</font></label> <input type="text"
	...
	<form method="post" action="${createTransactionUpi}"
		...
		<div class="row">
			<div class="col-md-2">
				<div class="form-group">
					<label><font size="4">UPI Id</font></label> <input type="text"
